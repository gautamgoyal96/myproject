Module seperation for admin and fron-end using HMVC and template seperation using template libraries
...
http://localhost/modular for front-end

and 

http://localhost/modular/admin for back-end
