...
class Notification_model extends CI_Model {
    ...
    function send_ios($token, $msg, $attrs=array()) {
        ...
        $push = new ApnsPHP_Push(
            ApnsPHP_Abstract::ENVIRONMENT_PRODUCTION,//ENVIRONMENT_PRODUCTION,//ENVIRONMENT_SANDBOX,
            $this->apnsDir.'pem/AVA.pem'//'AvaSandbox.pem'
        );
	...
	function send_chatNotification($registrationIds,$notification,$dataKey){  

		$ch = curl_init("https://fcm.googleapis.com/fcm/send");
		$arrayToSend = array('to' => $registrationIds, 'notification' => $notification,'data' => $dataKey,'priority'=>'high');
	    //Generating JSON encoded string form the above array.
	    $json = json_encode($arrayToSend);
	    //Setup headers:
	    $headers = array();
	    $headers[] = 'Content-Type: application/json';
	    $headers[] = 'Authorization: key= AAAA1eEQ060:APA91bHzVxblyapYPsfXqf8PxmgirM_qsspp6nGP_IPMMpWdHHyvDLr06hp4ry65QYl3z0NGhO2IK0Rdbvu24NLFy66zPtpO_9R9PEKIAh_EBJ6U-KUQ_bQ4MeG8o7MnC8VcOSgI56RX'; // key here
