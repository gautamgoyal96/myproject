            ...
            <tr>
                <td style="text-align: center; background: #8e804a;">
                    <table width="100%" border="0" cellpadding="30" cellspacing="0">
                        <tr>
                            <td>
                                <h2 style="color: #fff; margin: 0 0 5px; text-transform: capitalize; font-size: 35px; font-weight: normal;">Hello  <span style="color: #fff;">Avarents</span></h2>
                                <h4 style="color: #fff; margin: 15px 0 5px; font-size: 25px; font-weight: normal;"><?php echo ucfirst($firstName).' '.ucfirst($lastName);?></h4>
...
<!--                                 <div><img style="max-width: 100px; width: 100%; margin-bottom:10px;" src="<?php echo base_url().FRONT_THEME.'images/code-icon_jm.png';?>"></div>
 -->                                <h3 style="color: #333; font-size: 28px; font-weight: normal; margin: 0; text-transform: capitalize;">Forgot Password</h3>
                                <p style="color: #333; font-size: 16px; line-height: 28px;">We have received a request from your side to give your forgot password</p>
                                <a href="" style="background: #8e804a; color: #fff; margin: 15px 0 5px; font-size: 22px; display: inline-block; font-weight: normal; padding: 10px 25px; text-decoration:none;border-radius: 5px;"><?php echo $password; ?></a>
                            </td>
                        </tr>
                    </table>
