                    ...
                    <div class="panel-body container-fluid">
                        <form autocomplete="off" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-material">
                                ...
                                <input type="text" placeholder="Question" name="question" id="" class="form-control" value="<?php echo ($this->input->post('question') != '') ? $this->input->post('question') : ''; ?>">
                            </div>
                             <div class="form-group form-material">
                                <label for="inputText" class="control-label">Answer</label>
                                <input type="text" placeholder="Answer" name="answer" id="" class="form-control" value="<?php echo ($this->input->post('answer') != '') ? $this->input->post('answer') : ''; ?>">
                            </div>
                            <div class="form-group form-material">
                                <div class="">
