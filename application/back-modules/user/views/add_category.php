                        ...
                        <form autocomplete="off" method="post" enctype="multipart/form-data">
                           <!--  <div class="form-group form-material csMultiSelect">
                                <select id="brand" name="brandId[]" multiple >
                                    ...
                                    <option value="<?php echo $name->id; ?>" <?php if(isset($_POST['brandId']) && $this->input->post('brandId') == $name->id){ echo "selected='selected'";}?> ><?php if($name->status == 1){echo $name->brandName;} ?></option>
                                    <?php endforeach;?>
                                </select>
                            </div> -->
                            <div class="form-group form-material">
                                <label for="inputText" class="control-label">Name</label>
                                <input type="text" placeholder="Category name" name="categoryName" id="" class="form-control" value="<?php echo ($this->input->post('categoryName') != '') ? $this->input->post('categoryName') : ''; ?>">
                            </div>
                            <div class="form-group form-material">
                                <div class="">
