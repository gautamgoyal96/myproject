<div class="page animsition" style="animation-duration: 800ms; opacity: 1;">
    <div class="page-header col-sm-8">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url();?>user/allBrand">All Brand</a></li>
        </ol>
    </div>
                    ...
                    <div class="panel-body container-fluid">
                        <form autocomplete="off" method="post" enctype="multipart/form-data">
                            <div class="form-group form-material" id="engInput">
                                ...
                                <input type="text" placeholder="Brand name" name="brandName" id="" class="form-control" value="<?php echo ($this->input->post('brandName') != '') ? $this->input->post('brandName') : ''; ?>">
                            </div>
