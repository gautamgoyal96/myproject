...
<div class="page animsition">
    <div class="page-header">
        <h1 class="page-title">Brand's List</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>dashboard">Home</a></li>
            <!--   <li><a href="<?php echo base_url();?>user/addUser">Add Employee</a></li> -->        
        </ol>
        <div class="page-header-actions">
            <a href="<?php echo base_url();?>user/addBrand"><button data-original-title="Add Brand" data-toggle="tooltip" class="btn btn-sm btn-icon btn-primary btn-round waves-effect waves-light waves-round" type="button">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        If you want to delete this brand,whole record related to this brand will be deleted.
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <div class="form-group">
                                        ...
                                        autocomplete="on" onkeyup="javascript: ajax_fun('<?php echo base_url(); ?>user/allBrandListing')">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    ajax_fun('<?php echo base_url()."index.php/user/allBrandListing/".$page; ?>');
