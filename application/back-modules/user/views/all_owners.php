...
<div class="page animsition">
    <div class="page-header">
        <h1 class="page-title">Owner List</h1>
        <ol class="breadcrumb">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <div class="form-group">
                                        ...
                                        autocomplete="on" onkeyup="javascript: ajax_fun('<?php echo base_url(); ?>user/allOwnersListing')">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ajax_fun('<?php echo base_url()."user/allOwnersListing/".$page; ?>');
